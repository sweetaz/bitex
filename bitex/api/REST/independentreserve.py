...
class IndependentReserveREST(RESTAPI):
    ...
    def __init__(self, key=None, secret=None, version=None, config=None,
        ...
        addr = 'https://www.IndependentReserve.com/api' if not addr else addr
        super(IndependentReserveREST, self).__init__(addr=addr, version=version,
    ...
    def sign_request_kwargs(self, endpoint, **kwargs):
        ...
        IndependentReserve requires the parameters in the signature string and url to
