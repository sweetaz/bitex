"""KiwiCoin Interface class."""
# Import Built-Ins
import logging

# Import Homebrew
from bitex.api.REST.kiwicoin import KiwiCoinREST
...
class KiwiCoin(RESTInterface):
    """KiwiCoin Interface class."""

    def __init__(self, **api_kwargs):
        """Initialize Interface class instance."""
        super(KiwiCoin, self).__init__('KiwiCoin', KiwiCoinREST(**api_kwargs))

    # pylint: disable=arguments-differ
    def request(self, endpoint, authenticate=False, **req_kwargs):
        """Generate a request to the API."""
        if authenticate:
            return super(KiwiCoin, self).request('POST', endpoint, authenticate, **req_kwargs)
        return super(KiwiCoin, self).request('GET', endpoint, authenticate, **req_kwargs)
