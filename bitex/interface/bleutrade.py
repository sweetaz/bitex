"""Bleutrade Interface class."""
# Import Built-Ins
import logging

# Import Homebrew
from bitex.api.REST.bleutrade import BleutradeREST
...
class Bleutrade(RESTInterface):
    """Bleutrade Interface class."""

    def __init__(self, **api_kwargs):
        """Initialize Interface class instance."""
        super(Bleutrade, self).__init__('Bleutrade', BleutradeREST(**api_kwargs))

    # pylint: disable=arguments-differ
    def request(self, endpoint, authenticate=False, **req_kwargs):
        """Generate a request to the API."""
        if authenticate:
            return super(Bleutrade, self).request('POST', endpoint, authenticate, **req_kwargs)
        return super(Bleutrade, self).request('GET', endpoint, authenticate, **req_kwargs)
