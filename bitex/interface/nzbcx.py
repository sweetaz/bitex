"""NZBCX Interface class."""
# Import Built-Ins
import logging

# Import Homebrew
from bitex.api.REST.nzbcx import NZBCXREST
...
class NZBCX(RESTInterface):
    """NZBCX Interface class."""

    def __init__(self, **api_kwargs):
        """Initialize Interface class instance."""
        super(NZBCX, self).__init__('NZBCX', NZBCXREST(**api_kwargs))

    # pylint: disable=arguments-differ
    def request(self, endpoint, authenticate=False, **req_kwargs):
        """Generate a request to the API."""
        if authenticate:
            return super(NZBCX, self).request('POST', endpoint, authenticate, **req_kwargs)
        return super(NZBCX, self).request('GET', endpoint, authenticate, **req_kwargs)
