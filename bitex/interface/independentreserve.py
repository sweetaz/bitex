...
class IndependentReserve(RESTInterface):
    ...
    def request(self, endpoint, authenticate=False, **req_kwargs):
        ...
        if authenticate:
            return super(IndependentReserve, self).request('POST', endpoint, authenticate, **req_kwargs)
        return super(IndependentReserve, self).request('GET', endpoint, authenticate, **req_kwargs)
